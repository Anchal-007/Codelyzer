package com.eduthrill.codelyser.config;
...
public class MyAppSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    @Autowired
    private UserDetailsServiceImplementation userDetailsServiceImplemantation;
    ...
    protected void configure(AuthenticationManagerBuilder auth) throws Exception {
        auth.userDetailsService(userDetailsServiceImplemantation).passwordEncoder(passwordEncorder());
    }
